...
const BlogDetails = ({ params }) => {
    ...
    return (
        <div className="mt-28 max-w-screen-xl mx-auto px-8">
            <div className="bg-cover min-h-[350px] flex justify-center items-center" style={{ backgroundImage: "linear-gradient(to top, rgba(0, 8, 2, 0.9) 10%, rgba(5, 121, 33, 0.2) 70%), url('/assets/bg3.jpg')" }}>
                <div className="text-center">
                    <p className="font-semibold text-2xl tracking-wider max-w-96">{title}</p>
                    <div className="flex items-center gap-2 p-4 font-Basote">
            ...
            <div className="mt-16 flex gap-10">
                <div className="w-[65%]">
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-[#a19e9e] font-Basote">{description}</p>
                    </div>
                            ...
                            showComment?.map((comment) => (
                                <div key={comment._id} className="">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <p className="font-medium text-[#a19e9e]">{session?.data?.user?.name}</p>
                                    </div>
                    ...
                    <div className="font-Basote">
                        ...
                        <form className="w-full space-y-6 mt-5" onSubmit={handleComment}>
                            <div className="space-y-2 text-sm">
                                ...
                                <input
                                    className="h-10 w-full rounded border px-3 py-2 text-sm focus:outline-none bg-transparent text-[#a19e9e]"
