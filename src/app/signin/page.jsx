...
const SignIn = () => {
    ...
    return (
        <div className="grid grid-cols-2 gap-10 mt-32 max-w-screen-xl mx-auto p-8">
            <div>
                <Image src='/assets/log88.png' alt='photo' width={500} height={400}></Image>
            </div>
            <div className="border border-[--primary] p-4">
                <form className="space-y-6" onSubmit={handleSignIn}>
                    ...
                    <button type="submit" className="rounded-lg bg-[--primary] px-6 py-2 font-medium mt-5 w-full border border-[--primary] hover:bg-transparent">Sign In</button>
                </form>

                <div className="text-center text-sm text-zinc-700 pt-5">
                    Don’t have an account?
                    <Link href="/signup" className="ml-1 font-semibold underline text-[--primary]">
                        Signup
                    </Link>
                </div>
