...
const SignUpPage = () => {
    ...
    return (
        <div className="grid grid-cols-2 gap-10 mt-32 max-w-screen-xl mx-auto p-8">
            <div>
                <Image src='/assets/log88.png' height={400} width={500} alt='photo'></Image>
            </div>
                ...
                <form className="space-y-6" onSubmit={handleSignUp}>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <span className="absolute left-2 top-2">
                                <svg className="inline-block w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    <path className="fill-zinc-700" fillRule="evenodd"
                                        clipRule="evenodd" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                                    <rect x="2.5" y="2.5" width="19" height="19" rx="3.5" stroke="#000000"></rect>
                                </svg>
