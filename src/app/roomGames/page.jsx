            ...
            <div className="mx-auto max-w-[340px] space-y-3 rounded-lg bg-[#302f2fbf]">
                <div className="relative flex h-48 w-full justify-center lg:h-[260px]">
                    <div className="absolute left-4 right-4 top-4 flex items-center justify-between">
                        ...
                        <button className="rounded-lg bg-[--primary] px-2 py-1 text-sm font-medium duration-200 hover:bg-black/90">{game.price}</button>
                    </div>
                    <Image height={400} width={400} alt="photo" src={game.img} className="rounded-lg object-cover"></Image>
                </div>   
